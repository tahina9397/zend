$(document).ready(function(){
    if ($('#data-table').length) {
        ...
        // Basic datatable
        var current_date_table = $("#data-table") ,
        id_product = current_date_table.data("id_product") ;

        current_date_table.DataTable({
            ajax: {
                "url" : baseUrl+"/lots/getlots/?id_product="+id_product
            },
